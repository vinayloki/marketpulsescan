"""
MarketPulseScan — Canonical Sector Taxonomy

Port of legacy config/sector_map.py.
...
Usage:
    from marketpulse.config.sector_map import normalize_sector, CANONICAL_SECTORS
...
def normalize_sector(raw_sector: str | None) -> str:
    """
    Convert any raw sector string to a canonical India-market sector label.
